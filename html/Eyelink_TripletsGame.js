...
function EncodingTrialsLoopBegin(EncodingTrialsLoopScheduler) {
  ...
  for (const thisEncodingTrial of EncodingTrials) {
...
function RetrievalTrialsLoopBegin(RetrievalTrialsLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisRetrievalTrial of RetrievalTrials) {
...
function EncodingBlock2LoopBegin(EncodingBlock2LoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisEncodingBlock2 of EncodingBlock2) {
...
function RetrievalBlock2LoopBegin(RetrievalBlock2LoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisRetrievalBlock2 of RetrievalBlock2) {
...
function first_viewRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of first_viewComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function second_viewRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of second_viewComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function methodQTextRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of methodQTextComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function MethodCheckRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of MethodCheckComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function clicked_soundRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of clicked_soundComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function initRecallPicsRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of initRecallPicsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function RetrievalImageRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of RetrievalImageComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Q2TextRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of Q2TextComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
